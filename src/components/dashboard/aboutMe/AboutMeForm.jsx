  ...
  return (
    <form className="flex flex-col gap-5">
      <div className="form-control">
        <label htmlFor="name" className="text-lg text-white font-notoSans mb-2">
          Full Name:
        </label>
        <input
          type="text"
      ...
      <div className="form-control">
        <label htmlFor="role" className="text-lg text-white font-notoSans mb-2">
          Role:
        </label>
        <input
          type="text"
